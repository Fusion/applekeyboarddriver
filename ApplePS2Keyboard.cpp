...
{
  IOLog("PS2 Keyboard Driver - patched by CFR -v2\n");
  //
...
{
  // CFR: Always claim victory...this driver is especially meant for laptops
  // as laptops keyboards use the PS2 interface.
  return this;
}
